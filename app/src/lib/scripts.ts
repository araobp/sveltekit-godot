...
const bach: string = `The Project Gutenberg EBook of Johann Sebastian Bach by
...
Bach's half a century earlier, began at Lüneburg, where, at the
...
Schwerin as “Chorpräfect,” and enjoyed the favour of the Grand
Duke. Three years later he betook himself (1769), at the age of
twenty, to the University of Göttingen, which he entered as a [x]
...
in 1774 published at Göttingen his first work, _Ueber die Theorie_
...
spent at Göttingen, where he died on March 17, 1818, having
...
Hoffmeister and Kühnel, predecessors of C. F. Peters at Leipzig,
...
published from Hoffmeister and Kühnel's “Bureau de Musique”
his _Ueber Johann Sebastian Bachs Leben, Kunst und Kunstwerke._
_Für patriotische Verehrer echter musikalischer Kunst,_ of which
...
brief account of Bach in his _Lebensbeschreibungen berühmter_ [xv]
_Musikgelehrten und Tonkünstler neuerer Zeit._
Four years after Hiller's notice, Ernst Ludwig Gerber
published at Leipzig, in two volumes, 1790-92, his _Historisch-_
_biographische Lexikon der Tonkünstler._ As in Hiller's case,
...
Breslau in 1801 his _Museum deutscher Tonkünstler,_ a work
...
Handel were members. Mizler's journal, the _Neueröffneter Musikalischer_
...
But the announcement that Messrs. Hoffmeister and Kühnel, the
...
Messrs. Hoffmeister and Künel's project promises at once to
...
8 The firm of Hoffmeister and Kühnel was founded at Leipzig in 1800
...
scheme of Hoffmeister and Kühnel, to which Forkel alludes, and in which he
participated.
...
in the possession of Carl Philipp Emmanuel, Forkel, and G. Pölchau, the
...
the latter. From C. P. E. Bach it passed to G. Pölchau and from him to the
...
Böhm. [56] Johann Christoph possessed a book containing several
...
Church, Nürnberg. His influence upon the organ playing of his generation was
...
Lübeck, and the chief musical influence in North Germany.
...
for Lüneburg with one of his Ohrdruf schoolfellows, named
...
while he was at Lüeburg, he several times travelled to Hamburg
...
The date and circumstances of his removal from Lüneburg to
...
free commons.
61 Probably Georg Böhm, who had relations with the Convent choir, inspired
Bach to make the pilgrimage. Böhm, then at St. John's, Lüneburg, was a pupil
...
and Organ playing, [68] walked the whole way to Lübeck to hear
...
at the Church of St. Blasius, Mühlhausen, he accepted in


had leisure and the means to employ it. In October 1705 he obtained four
weeks' leave of absence and set off on foot to Lübeck, after leaving an efficient
...
discipline. Before his Lübeck visit he engaged in a street brawl with one
...
Bach's migration to Mühlhausen no doubt was grateful to both. His resignation
...
Mühlhauson prided itself upon its musical traditions. Bach's Cantata, No.
71, written in February 1708 for the inauguration of the Mühlhausen Town
...
infra, p. 188.
71 Bach's petition to the Mühlhausen Consistory for permission to resign his
...
things will be altered” for the better. Mühlhausen, in fact, was a stronghold of
...
of the Church of St. Honoré, Paris. His arrival in Dresden was due to his
...
Anhalt-Cöthen, a good judge of music and a first-rate amateur, [87]
...
based upon Joseph Fétis (1784-1871). According to this story of the event,
...
him both at Cöthen and after he had left his service.
...
excited general admiration. The veteran Reinken—he was nearly
one hundred years old—was particularly impressed by Bach's
performance. After he had treated the Choral _An Wasserflüssen_
...
88 The reason for Bach's migration from Weimar to Cöthen was his failure to
...
to the Court of Cöthen. Duke Wilhelm Ernst refused to release him from his
...
his last work at Weimar was to put the _Orgelbüchlein_ into the form in which it
...
of Anhalt-Cöthen had great regard for him and Bach left his
service with regret. [95] But he saw the finger of Providence in


_Wasserflüssen Babylon,_ are extant. See notes upon them and their relation to
...
which he himself conducted at Cöthen. [97] While he was at St.
...
return to the Organ, explains his abandonment of the more dignified Cöthen
appointment.
...
Schweitzer, ii. 208.
98 In 1723 he received the title Hochfürstlich Weissenfelsische wirkliche

Kapellmeister and retained it till his death. He retained also his Cöthen
appointment.
...
_Historisch-kritische Beyträge zur Aufnahme der Musik,_ which appeared in
...
Prelude (Novello bk. xvii. 85) on the melody _Wenn wir in höchsten Nöthen_
...
Gottlieb Görner, already Organist of St. Nicolas' since 1721,
...
under Görner's direction. As to St. Peter's, its services, which
...
a Chorpräfect. At St. Thomas' and St. Nicolas' Bach personally
...
occasions the second choir was conducted by a Chorpräfect. The
...
with the Hymn, Allein Gott in der Höh' sei Ehr, the German
...
fry, such as Görner, who had presumed on Bach's aloofness
...
participated. The recognised fee for piecès d'occasion of a
...
Doctor August Friedrich Müller's name-day. In 1726 he revived
...
performance of the Cöthen Cantata to yet another text ( _Die_
_Freude reget sich_ ). On November 21, 1734, the lost Cantata [44]
_Thomana sass annoch betrübt_ was sung at the induction of
...
family, _Tönet, ihr Pauken, erschallet Trompeten,_ of which he
...
115 _Steigt freudig in die Luft,_ first performed at Cöthen, set to a new text,
...
Augustus III. The music had already done duty in Dr. Müller's
honour in 1725. On the following October 5, 1734, when the
King visited Leipzig, Bach's hurriedly written Cantata, _Preise_
_dein Glücke, gesegnetes Sachsen,_ whose first chorus became the
...
performed a work— _Willkommen, ihr herrschenden Götter der_
...
unpretentious—such were the qualities of one who towers above
...
117 His _Versuch über die wahre Art des Klavier zu spielen_ was published (Part
I.) in 1753.
...
is the principal finger—for the difficult keys, as they are called,
are unplayable without it—it is not equally indispensable with
...
was in general known as the “Flügel,” the strings being plucked, or flipped
...
be regarded as exceptions to this general rule—Bach and his
...
looks at Bach's simple four-part Hymn tunes (Choralgesänge)
...
his artistic ends—in a word, his transcendent genius brought the
...
from it. Such people are merely Finger Composers—in his riper
years Bach used to call them Harpsichord Knights—that is to say,
...
no doubt I should have joined the noble army of piano thumpers…Sometimes
I regret my ignorance, yet, when I think of the ghastly heap of platitudes for
which that unfortunate piano is made the daily excuse—insipid, shameless
productions, that would be impossible if their perpetrators had to rely, as they
ought, on pencil and paper alone—then I thank the fates for having forced me
...
attracted musicians, like Bach, whose work at Cöthen was in close association
...
Böhm, and certain French organists who were famed in those
days as masters of harmony and fugue. [142]


The models he selected—Church musicians for the most

part—and his own disposition inclined him to serious and exalted
...
added richness. A melody so accompanied—even though all
the notes are not those of the true Bass—or treated with simple
...
later text, from which Hoffmeister and Kühnel's edition of that
...
no creaking of machinery is perceptible; yet no single bar—I
might almost say no part of a bar—is like another. Every
...
they seem obscured by the melodic parts that accompany them—I
...
_Variations,_ [151] in the first Part of the _Clavierübung,_ [152] in the
...
_Vierstimmige Choralgesänge_ (“Four-part Hymn-tunes”), which
...
working.
159 Johann Sebastian Bach's _Vierstimmige Choralgesänge_ were published in
1765 and 1769. C. P. E. Bach was concerned only with the first volume. Forkel
perhaps refers to an edition of the _Choralgesänge_ issued by Breitkopf in four
...
completed the _Orgelbüchlein_ and the greater part of his Organ works.
...
Cantatas, one of which was performed at Cöthen at the funeral
...
172 There is a tradition that Bach wrote a comic song, _Ihr Schönen, höret an,_
...
_Einige höchst nöthinge Regeln_ at the end of A. M. Bach's _Notenbuch_ (1725).
...
3. GOLDBERG, of Königsberg. He was a very finished
...
7. MÜTHEL, of Riga. He was a good Clavier player and
...
193 Johann Gottfried Müthel, b. circ. 1720, d. circ. 1790; pupil of Bach in
...
second, _Wahre Grundsätze zum Gebrauch der Harmonie._ [196]
...
195 Louisa Amalia, of Brunswick-Wolfenbüttel, wife of Frederick the Great's
...
Buttelstädt, and his sons, Johann Ludwig, Johann Tobias, and Johann Carl;
...
at the Court of Bückeburg, imitated Carl Philipp's style, but was
...
naïveté but did not permit him to suspect his amusement. [207]
...
town. On his first visit in 1719, Bach was at Cöthen, only some
...
Cöthen, Duke Ernst August of Weimar, [220] and Duke Christian of
...
supports Spitta and regards the Variations as having been engraved at Nürnberg
“vers 1746.”
...
223 The first of Bach's works to be engraved was the Mühlhausen Cantata, _Gott_
_ist mein König,_ (parts only). It was published in 1708, when Bach was twentythree years old. Forkel refers to Partita I. in the first Part of the _Clavierübung_
...
the first Part of the _Clavierübung_ (P. bks. 205, 206).
...
1. _Clavierübung_, or “Exercises for the Clavier, consisting
...
Cantata _Gott ist mein König_ had been published by the Town Council at
Mühlhausen in 1708.
...
Published by Christopher Weigel, Junior, in Nürnberg.” [229]
...
4. _Sechs Choräle_, or “Six Choral Melodies of different
kinds, for an Organ with two manuals and pedal. Zella, in
the Thuringian Forest. Published by Johann G. Schübler.” [231]
...
227 In 1801 Hoffmeister and Kühnel unsuccessfully attempted to publish Bach's
...
5. _Clavierübung_, or “Exercises for the Clavier, consisting
of an Aria with several Variations, for a Clavier with two
manuals. Published by Balthasar Schmidt at Nürnberg.” [234]
...
1 ovvero 2 Clav.”
237 The movement is constructed upon two merry folk-songs, _Kraut and Rüben_
...
6. _Einige kanonische Verdäderungen,_ “Canonic Variations
on the Christmas Hymn ‘Vom Himmel hoch da komm ich
her,’ for an Organ with two manuals and pedal. Published
at Nürnberg by Balthasar Schmidt.” The work contains five
...
B A C H; and the Choral Prelude “Wenn wir in höchsten Nöthen sein.”
...
wir in höchsten Nöthen sein,” which he dictated to his
...
edition of the _Choralgesänge,_ conjectures that Kirnberger was responsible for
the second.
...
finger as well. They were composed at Cöthen in 1723, [124]
...
Friedemann's _Clavierbüchlein_ (B.G. XLV. (1)), and the remaining five have
survived in texts handed down by others of Bach's pupils. The eighteen are in
P. bk. 200.
256 The Autograph was written at Cöthen and is dated 1723. It also contains
...
etwas Musik von Sebastian, sonst genannt: Fantasia chromatica; bleibt schön in alle Saecula.”
...
may certainly be assigned to the Cöthen period. They are published in P. bks.
203, 204.
267 The French Suites undoubtedly date back to the Cöthen period, since they
...
at Cöthen, they are among Bach's masterpieces in this form
...
composer that may perhaps be older—namely, Pachelbel of
Nürnberg's Toccata, as he called it. Pachelbel, however,
...
_Clavierübung._ Its Fugue is known as the “St. Anne's.”
...
“Sei gegrüsset, Jesu gütig.” The pedal is only required in one movement of the
...
Arnstadt or Lüneburg cannot be stated.
...
nowhere mentions, as well as the third Part of the _Clavierübung,_ the _Schübler_
...
the _Orgelbüchlein_ ; otherwise he could hardly have failed to introduce it in this
...
the late Cöthen period. The 1720 MS. is in A. M. Bach's handwriting and was
...
wrote also three secular wedding Cantatas: _Weichet nur, betrübte Schatten_ (c.
...
Motets—the five mentioned by Forkel and another, _Ich lasse dich nicht,_ of
...
_Choralgesänge_, No. 123, or that in B.G. XLI. p. 177.
...
325 Also in Wilhelm Friedemann's _Clavierbüchlein._ See Schweitzer, i. 279;
Spitta, ii. 166.
...
of his art, along with an unrivalled technique—these qualities,
...
harmonisches Labyrinth” (Dörffel, p. 88, tigs. 131-33), the genuineness of
...
### III. Catalogue Of Bach's Compositions At Cöthen, 1717-23, from his thirty-third to his thirty-ninth year. Vocal:—
...
at Cöthen and the last two (D major and D major) at Leipzig. Schweitzer (i.
...
or, Auf schmetternde Töne der muntern Trompeten (after
1733).
...
Do. Von der Vergnügsamkeit, _or_ Ich bin in mir vergnügt
(c. 1730).
...
Clavierübung, Part I. containing the six Partitas, or German
...
catalogued among the Clavier works of the Cöthen period. Schweitzer (i. 340)
...
Do. Willkommen, ihr herrschenden Götter der Erden (1738)
(music lost).
...
Clavierübung, Part II. containing the Italian Concerto (bk.
207) and Partita in B minor (bk. 208) (1735).
Fantasia and Fugue in C minor (bk. 207 p. 50 and bk. 212
p. 88) (c. 1738).
Clavierübung, Part III. containing the four Duetti (bk. 208)
(1739).
Clavierübung, Part IV. containing the Goldberg Variations
(bk. 209) (c. 1742).
...
The Catechism Choral Preludes (in Clavierübung, Part III.)
(bk. 16) (1739).
...
his own efforts at authorship—Paul Wagner's eight-volumed
Hymn-book—whence he took the stanzas which decorate his
...
359 The intimate personal note of the opening words of the Recitative—“Mein
Jesus ware tot”—reveals him.
...
northern Germany through Bach's earlier residence at Lüneburg
...
St. Blasius at Mühlhausen. [361] Here, within the space of ten
...
inauguration of the Mühlhausen Town Council, and consists of
...
Consistorial Assessor, at Mühlhausen. He was, moreover, an
aggressive foe of Pietism, of which Mühlhausen was the citadel,
...
him from Mühlhausen, in hope, in his own words, “to realise my
...
Mühlhausen libretti and the suppression of the personal note
already sounded in Bach's Arnstadt Cantata. Nor did Eilmar's
influence pass with Bach's departure from Mühlhausen. [367] It is
...
the Mühlhausen period. Their texts display Eilmar's preference
...
to the Mühlhausen period. If so, it is probable that the libretto, a
...
set, in all, seven of the libretti—four from the fourth cycle, [382] one
...
appointment at Cöthen on 1st August 1717, and took up his duties
...
dedication in 1708. The Cöthen Court was unpretentious. The
...
Bach's arrival at Cöthen, Helbig published a cycle of “Musical
...
Only these two Cantatas were composed at Cöthen. But later,
...
Prince Leopold of Anhalt-Cöthen, is a masterly conversion into
...
the god-parents chosen by Bach for his children—Eilmar, for
instance—as revealing Bach's intimate associates at the moment,
...
afterwards famous as the “Bückeburg Bach.” [420] In 1737 his son
...
So far as they can be identified—the attempt is somewhat
speculative—Weiss provided Bach with at least thirty-three
...
the incomplete Cantata, _Ehre sei Gott in der Höhe._
...
after Trinity—Bach produced a Cantata [429] whose Arias are set to
...
433 The volume is entitled _Sammlung Erbaulicher Gedancken, Bey und über_
...
hymn-stanzas—invariably used for the first and last movements,
and occasionally elsewhere—but chiefly of paraphrased stanzas
...
part, they are—children of their period and blemished with
its imperfections—they enshrine an extraordinarily interesting
...
service not less exalted—a great artist, a great Protestant, a great
man. [476]
...
|No.|Date.|Title.|Author of<br>Libretto.|Composition<br>of the Text.|
|---|---|---|---|---|
|*189|c.<br>1707-<br>10. Visita-<br>tion of the<br>B.V.M.|Meine<br>Seele<br>rühmt und<br>preist.|Author<br>unknown.<br>?Com-<br>posed<br>at<br>Muhlhausen.|A<br>para-<br>phrase<br>of<br>the<br>“Mag-<br>nificat.”<br>Tenor Solo.|
|150|c.<br>1710.<br>?Occasion.|Nach<br>dir,<br>Herr,<br>ver-<br>langet mich<br>(Psalm<br>xxv. 1).|?Bach.<br>?Com-<br>posed<br>at<br>Mühlhausen.|Psalm xxv.<br>1,<br>2,<br>5,<br>15;<br>rest<br>of<br>libretto<br>perhaps<br>by<br>Bach.<br>See<br>_Bach-_<br>_Jahrbuch_<br>for 1913, p.<br>39, on au-<br>thenticity<br>of Cantata.|
...
|18|1714 (or<br>1713). Sex-<br>agesima.|Gleich wie<br>der Regen<br>und Schnee<br>vom Him-<br>mel fällt<br>(Isaiah lv.<br>10-11).|Erdmann<br>Neumeister<br>“Fünffache<br>Kirchen-<br>Andachten”<br>(Leipzig,<br>1716) (Ser.<br>iii.).|Isaiah lv.<br>10, 11; four<br>clauses of<br>the Litany;<br>Stanza viii.<br>of Lazarus<br>Spengler's<br>hymn,<br>“Durch<br>Adams Fall<br>ist ganz<br>verderbt”;<br>rest of<br>libretto<br>original. S.<br>T. B. Soli.|
|---|---|---|---|---|
|*160|1714<br>(or<br>1713).<br>Easter Day.|Ich<br>weiss,<br>dass<br>mein<br>Erlöser<br>lebt.|Erdmann<br>Neumeister<br>(Ibid., Ser.<br>I.).<br>Slight<br>verbal<br>alterations<br>by Bach.|Original<br>throughout.<br>Tenor Solo.|
...
|161|1715. Six-<br>teenth S.<br>after Trin-<br>ity (also for<br>Purifica-<br>tion).|Komm,<br>du süsse<br>Todesstunde.|Salomo<br>Franck<br>(Ibid.,<br>p. 162);<br>verbal<br>alterations<br>by Bach.|Stanza<br>iv. of<br>Christoph<br>Knoll's<br>hymn,<br>“Herzlich<br>thut mich<br>verlangen”;<br>rest origi-<br>nal. A. T.<br>Soli.|
|---|---|---|---|---|
|†162|1715.<br>Twentieth<br>S.<br>after<br>Trinity.|Ach,<br>ich<br>sehe,<br>jetzt<br>da ich zur<br>Hochzeit<br>gehe.|Salomo<br>Franck<br>(Ibid.,<br>p.<br>172).|Stanza vii.<br>of<br>Johann<br>Georg<br>Albinus'<br>hymn,<br>“Alle<br>Menschen<br>müssen<br>sterben”;<br>rest<br>of<br>libretto<br>original.|
...
|No.|Date.|Title.|Author of<br>Libretto.|Composition<br>of the Text.|
|---|---|---|---|---|
|173|c.<br>1718.<br>Birthday<br>Serenade;<br>new<br>text<br>(c.<br>1730)<br>for<br>Whit<br>Monday.|Erhötes<br>Fleisch und<br>Blut.|The music<br>of<br>the<br>Cantata<br>is<br>that of the<br>Birthday<br>Serenade,<br>“Durehlauch<br>ster<br>Leopold”<br>(omitting<br>numbers<br>5<br>and<br>6).<br>Cantata<br>text<br>prob-<br>ably<br>by<br>Bach.|t'-<br>Original<br>throughout.|
...
|47|?1720.<br>Seven-<br>teenth<br>S. after<br>Trinity.|Wer sich<br>selbst<br>erhöhet,<br>der soll<br>erniedriget<br>werden (St.<br>Luke xiv.<br>11).|Johann<br>Friedrich<br>Helbig<br>(“Auf-<br>munterung<br>zur An-<br>dacht,”<br>Eisenach,<br>1720, p.<br>114.|St. Luke<br>xiv. 11;<br>Stanza<br>xi. of<br>anonymous<br>(?Hans<br>Sachs)<br>hymn,<br>“Warum<br>betrubst du<br>dich, mein<br>Herz”; rest<br>original. S.<br>B. Soli.|
|---|---|---|---|---|
...
|No.|Date.|Title.|Author of<br>Libretto.|Composition<br>of the Text.|
|---|---|---|---|---|
|22|1723.<br>Quinqua-<br>gesima.<br>(“Es-<br>tomihi”).|Jesus nahm<br>zu sich die<br>Zwölfe (St.<br>Luke xviii.<br>31).<br>[See<br>No.<br>31<br>(1715).]|?Bach<br>(composed<br>at Cöthen).<br>Trial<br>Cantata<br>(February<br>7, 1723).|St.<br>Luke<br>xviii.<br>31,<br>34; Stanza<br>v.<br>of<br>Elisabothe<br>Gruciger's<br>hymn,<br>“Herr<br>Christ,<br>der<br>einig'<br>Gott's<br>Sohn”; rest<br>original. A.<br>T. B. Soli.|
...
|76|1723. Sec-<br>ond S. after<br>Trinity.<br>Also for<br>Refor-<br>mation<br>Festival.|?Christian<br>Weiss,<br>senr.|Die<br>Himmel<br>erzahlon<br>die Ehre<br>Gottes<br>(Psalm xix.<br>1, 3).|Part I.:<br>Psalm<br>xix. 1,3;<br>Stanza i.<br>of Luther's<br>hymn,<br>“Es woll'<br>uns Gott<br>genädig<br>sein”; Part<br>II.: Stanza<br>iii. of<br>the same<br>hymn; rest<br>of libretto<br>original.<br>See Spitta<br>ii. 357n.|
|---|---|---|---|---|
|24|1723.<br>Fourth<br>S.<br>after<br>Trinity.|Ein<br>unge-<br>farbt<br>Gemüthe.|Erdmann<br>Neumeister<br>(“Fünf-<br>fache<br>Kirchen-<br>Andachten”)<br>(Ser. IV.).|St.<br>Matthew<br>vii.<br>12;<br>Stanza<br>i.<br>of<br>Johann<br>Heer-<br>mann's<br>hymn,<br>“O<br>Gott,<br>du<br>frommer<br>Gott”; rest<br>of<br>libretto<br>original. A.<br>T. B. Soli.|
...
Höchsterwünschtes?Bach. _Part_ _I.:_
...
|184|1724. Whit<br>Tuesday.|Erwunschtes<br>Freuden-<br>licht.|?Bach. An<br>adaptation<br>of an ear-<br>lier secular<br>Cantata<br>(Spitta, ii.<br>399).|Stanza vüi.<br>of Anark of<br>Wildenfeis'<br>(?) hymn,<br>“O Herre<br>Gott, dein<br>göttlich<br>Wort”; rest<br>of libretto<br>original. S.<br>A. T. Soli.|
|---|---|---|---|---|
...
|77|1725. Thir-<br>teenth S. af-<br>ter Trinity.|Du sollst<br>Gott,<br>deinen<br>Herren,<br>lieben (St.<br>Luke x.<br>27).|?Christian<br>Weiss,<br>senr.|St. Luke<br>x. 27;<br>Stanza viii.<br>of David<br>Denicke's<br>(?) hymn,<br>“Wenn<br>einer alle<br>Ding ver-<br>stünd”<br>(posthu-<br>mously<br>added to<br>Bach's<br>text); rest<br>of libretto<br>original.|
|---|---|---|---|---|
...
|93|?1728.<br>Fifth S. af-<br>ter Trinity.|Wer nur<br>den lieben<br>Gott lässt<br>walten.|Georg Neu-<br>mark (ar-<br>ranged by<br>?Picander).|Choral<br>Cantata;<br>Stanzas<br>i., iv., v.,<br>vii. of<br>Neumark's<br>hymn are<br>retained in<br>their orig-<br>inal form;<br>Stanzas ii.,<br>iii., vi. are<br>inserted<br>or para-<br>phrased<br>in the<br>Arias and<br>Recitativi.|
|---|---|---|---|---|
|†Incomplete|?1728.<br>Christmas<br>Day.|Ehre<br>sei<br>Gott in der<br>Höhe<br>(St.<br>Luke<br>ii.<br>14).|Picander<br>(“Can-<br>taten,”<br>1728-29, p.<br>71).|St.<br>Luke<br>ii.<br>14;<br>Stanza<br>iv.<br>of<br>Caspar<br>Ziegler's<br>hymn, “Ich<br>freue mich<br>in dir”; rest<br>original. A.<br>B. Soli.|
...
|---|---|---|---|---|
|†l88|1730<br>(or<br>1731).<br>Twenty-<br>first S. after<br>Trinity. In-<br>corporates<br>older<br>in-<br>strumental<br>material.|Ich<br>habe<br>meine<br>Zuver-<br>sicht.|Picander<br>(“Can-<br>taten,”<br>1728-29, p.<br>47). Music<br>proba-<br>bly<br>by<br>Wilhelm<br>Friede-<br>mann Bach<br>to a large<br>extent.|Stanza i. of<br>Sigismund<br>Weingärt-<br>ner's<br>(?)<br>hymn,<br>“Auf<br>meinen<br>lieben<br>Gott”; rest<br>of<br>libretto<br>original.<br>Organ<br>obbligato.|
...
|†174|1731 (or<br>1732).<br>Whit<br>Monday.<br>Incorpo-<br>rates older<br>instru-<br>mental<br>mate-<br>rial. [See<br>No. 194<br>(1723).]|Ich liebe<br>den<br>Hochsten<br>von<br>ganzem<br>Gemüthe.|Picander<br>(“Can-<br>taten,”<br>1728-29, p.<br>147).|Stanza i.<br>of Martin<br>Schalling's<br>hymn,<br>“Herzlich<br>lieb hab'<br>ich dich, O<br>Herr”; rest<br>of libretto<br>original. A.<br>T. B. Soli.|
|---|---|---|---|---|
...
|---|---|---|---|---|
|†55|1731<br>(or<br>1732).<br>Twenty-<br>second<br>S.<br>after<br>Trinity.|Ich<br>armor<br>Mensch,<br>ich<br>Sün-<br>denknecht.|Author un-<br>known.|Stanza<br>vi.<br>of Jo-<br>hann Rist's<br>hymn,<br>“Werde<br>munter,<br>mein<br>Gemuthe”;<br>rest<br>of<br>libretto<br>original.<br>Tenor Solo.|
...
|---|---|---|---|---|
|*170|?1732.<br>Sixth<br>S.<br>after<br>Trinity.|Vergnügte<br>Ruh,<br>be-<br>liebte<br>Seelenlust.|Author un-<br>known.|Original<br>throughout.<br>See Spitta,<br>ii.<br>453n.<br>Alto<br>Solo<br>and Organ<br>obbligato.|
...
|---|---|---|---|---|
|137|?1732.<br>Twelfth<br>S.<br>after<br>Trinity.|Lobe<br>den<br>Herren, den<br>mächtigen<br>König<br>der Ehren.|Joachim<br>Neander.|Choral<br>Cantata.<br>The<br>five<br>stanzas<br>of<br>the<br>hymn<br>are<br>set<br>in<br>their<br>original<br>form. S. A.<br>T. Soli.|
...
|117|_c._<br>1733.<br>Occa-<br>sion<br>not<br>specified.|Sei<br>Lob<br>und<br>Ehr'<br>dem<br>hochsten<br>Gut.|Johann<br>Jakob<br>Schütz.|Choral<br>Cantata.<br>The<br>nine<br>stanzas<br>of<br>the<br>hymn<br>are<br>set<br>in<br>their<br>original<br>form. A. T.<br>B. Soli.|
...
|*53|1723-34.<br>?For<br>a<br>Funeral.|Schlage<br>doch,<br>gewün-<br>schte<br>Stunde.|?Salomo<br>Franck.|A<br>single<br>eight-lined<br>original<br>stanza.<br>Alto Solo.|
...
|128|?1735.<br>Ascension<br>Day.|Auf Christi<br>Him-<br>melfahrt<br>allein.|Marianne<br>von Ziegler<br>(Ibid.).<br>Emended<br>by Bach.|Stanza i.<br>of Josua<br>Wegelin's<br>hymn,<br>“Auf<br>Christi<br>Him-<br>melfahrt<br>allein”;<br>Stanza<br>iv. of<br>Matthäus<br>Avenar-<br>ius's hymn,<br>“O Jesu,<br>meine<br>Lust”; rest<br>of libretto<br>original. A.<br>T. B. Soli.|
|---|---|---|---|---|
...
|†13|c. 1736.<br>Second S.<br>after the<br>Epiphany.|Meine<br>Seufzer,<br>meine<br>Thränen.|Author un-<br>known.|Stanza ii.<br>of Johann<br>Heer-<br>mann's<br>hymn,<br>“Zion<br>klagt mit<br>Angst und<br>Schmerzen”;<br>Stanza xv.<br>of Paul<br>Flem-<br>ming's<br>hymn,<br>“In allen<br>meinen<br>Thaten”;<br>rest origi-<br>nal.|
|---|---|---|---|---|
...
|†l51|c. 1740.<br>Feast of St.<br>John the<br>Evangelist.|Süsser<br>Trost,<br>main Jesus<br>kommt.|?Bach.|Stanza viii.<br>of Nikolaus<br>Herman's<br>hymn,<br>“Lobt Gott,<br>ihr Christen<br>alle gle-<br>ich”; rest<br>of libretto<br>original.|
|---|---|---|---|---|
...
|---|---|---|---|---|
|116|1744<br>(Nov. 15).<br>Twenty-<br>fifth S. after<br>Trinity.|Du Friede-<br>fürst, Herr<br>Jesu Christ.|Jakob<br>Ebert. Also<br>attributed<br>to Ludwig<br>Helmbold<br>(arranged).|Choral<br>Cantata.<br>Stanzas<br>i.<br>and<br>vii.<br>of the<br>hymn<br>are<br>set in their<br>original<br>form.<br>The<br>intervening<br>stanzas<br>are<br>para-<br>phrased.|
...
Society had fulfilled its fundamental purpose—the publication of
Bach's works—and on the very date of its dissolution the Neue
...
held at regular intervals—at Berlin in 1901, Leipzig in 1904,
Eisenach—in connection with the opening of the Museum—in
...
year of issue—I., II., III., and so forth. When more than one
...
(1855-81), one by Franz Kroll (1866), eleven by Alfred Dörffel
(1876-98), six by Paul Graf Waldersee (1881-94), five by Ernst
Naumann (1886-94), two by Franz Wüllner (1887-92), and two
...
No. 15. Denn du wirst meine Seele nicht in der Hölle
...
IV. 1854. *Passionsmusik nach dem Evangelisten Matthäus.
Ed. Julius Rietz.
...
XI (2). 1861 [1862]. Kammermusik für Gesang. Erster Band. Ed.
Wilhelm Rust.
...
Secular Cantata: Von der Vergnügsamkeit, or, Ich bin
in mir vergnügt.
...
XX (2). 1870 [1873]. Kammermusik für Gesang. Zweiter Band. Ed.
Wilhelm Rust.
...
XXI (2). 1871 [1874]. Kammermusik. Fünfter Band. Ed. Wilhelm
...
XXIV. 1874 [1876]. Kirchencantaten. Zwölfter Band. Ed. Alfred
...
(1) Orgelbüchlein (N. bk. 15), containing Preludes on
...
496 For an exposition of Bach's design in the “Orgelbüchlein,” see the present
...
_Christian Conduct and Experience—_


41. Ich ruf' zu dir, Herr Jesu Christ.


_In Time of Trouble—_
...
(4) Older texts of the “Orgelbülein” and “Eighteen”
Chorals:


1. Christus, der uns selig macht (Orgelbülein No.
22) (P. bk. 244 p. 108).
2. Komm, Gott, Schöpfer, heiliger Geist (Orgelbülein No. 33) (P. bk. 246 p. 86A).
...
5. An Wasserflüssen Babylon (Eighteen No. 3) (P.
bk. 245 p. 103).
...
15. Allein Gott in der Höh' sei Ehr' (Eighteen No. 13)
(P. bk. 245 p. 100).
16. Allein Gott in der Hö' sei Ehr' (Eighteen No. 14)
(P. bk. 245 p. 97).
...
taten No. 1-120. Ed. Alfred Dörffel.
...
XXIX. 1879 [1881]. Kammermusik für Gesang, Dritter Band. Ed.
Paul Graf Waldersee.
...
Church Cantata No. 194: Hochsterwünschtes Freuden
fest.
...
Secular Cantata: Mit Gnaden bekröne der Himmel die
...
XXX. 1880 [1884]. Kirchencantaten. Fünfzehnter Band. Ed. Paul
...
146. Wir müssen durch viel Trübsal in das Reich
...
[242]
XXXI (1). 1881 [1885] Orchesterwerke. Ed. Alfred Dörffel. (P. bk.
219)
...
XXXIV. 1884 [1887]. Kammermusik für Gesang. Vierter Band. Ed.
Paul Graf Waldersee.
...
Secular Cantata: Tönet, ihr Pauken! Erschallet,
Trompeten.
Secular Cantata: Preise dein Glücke, gesegnetes Sach
[244] sen.
...
508 They are described as “zur vierten französischen Suite.” The Prelude is in
P. bk. 1959 p. 67.
...
XXXIX. 1889 [1892]. Motetten, Choräle und Lieder. Ed. Franz
...
5 (388). Wär' Gott nicht mit uns diese Zeit (Wo Gott der
Herr nicht bei uns hält). [520]
...
inoluded in Breitkopf and Haertel's edition (1898) of Bach s “Choralgesänge”;
...
170 (336). Was betrübst du dich, mein Herze (Bach's
melody).
...
1. Wer nur den lieben Gott lässt walten (N. bk. 19
p. 21).
...
p. 16).
7. Christum wir sollen loben schon, _or_, Was fürcht'st
...
41).
15. Lob sei dem allmächtigen Gott (Fughetta) (N. bk.
18 p. 73).
...
23. Allein Gott in der Höh' sei Ehr (Bicinium) (N. bk.
18 p. 5).
...
p. 19).
27. Wie schön leuchtet der Morgenstern (N. bk. 19 p.
23).
...
13. Wie schön leuchtet der Morgenstern (fragment)
(not in N. or P.).
...
8. Schmücke dich, O liebe Seele (not in N. or P.)
...
11. Wir glauben all' an einen Gott, Schöpfer (P. bk.
2067 p. 40). [530]

12. Variations on Ach, was soll ich Sünder machen
(not in N. or P.).
13. Variations on Allein Gott in der Höh' sei Ehr' (not
in N. or P.).
...
Allein Gott in der Höh' sei Ehr' (an early version
...
herrühren.” The text is complete, and the omission of the Prelude from the
...
XLIII (2). 1893 [1894]. Musikstücke in den Notenbüchen der Anna
...
1. Partita III. (A minor) from the “Clavierübung,”
Part I. (see B.G. III.).
...
“Menuet fait par Mons. Böhm,” Peters' Bk. 1959 contains the remaining
...
11. Choral Prelude, “Wer nur den lieben Gott lässt
...
33. Aria, “Warum betrübst du dich” (see B.G.
XXXIX. sec. 3 no. 72).
...
The “Clavier-Büchlein” of Wilhelm Friedemann Bach
...
3. Choral Prelude, “Wer nur den lieben Gott lässt
...
II (1). 1902. Orgelbüchlein. 46 kürzere Choralbearbeitungen für
...
III(2). 1903. Drei Sonaten für Klavier und Violine. Ed. Ernst
...
IV (1). 1904. Drei Sonaten für Klavier und Violine. Ed. Ernst
...
1. Auch mit gedämpften schwachen Stimmen (Cantata
36: Violin).
...
3. Bachs Rezitativbehandlung mit besonderer Berück
...
Arien für Alt. Ed. Eusebius Mandyczewski.
...
Abteilung: Duette für Sopran und Alt. Ed. Eusebius
Mandyczewski.
...
5. Verzeichnis der bisher erschienenen Literatur über
...
1. Erfahrungen und Ratschlüger bezüglich der Aufführung Bachscher Kirchenkantaten. By Wilhelm
Voigt. [273]
2. Über die Schickssle der der Thomasschule zu Leipzig
angehorenden Kantaten Joh. Seb. Bachs. By Bernhard
Fr. Richter.

3. Die grosse A-moll Fuge für Orgel [Novello bk. 7 p.
...
Johann Sebastian Bach. By Max Schneider.
6. Übersicht der Aufführungen J. S. Bachscher Werke
...
IX (4). 1909. Brandcnburgisches Konzert No. 3 für Klavier zu vier
Händen. Ed. Max Seiffert and Max Schneider.
...
Woldemar Voigt.
2. Über Seb. Bachs Kantaten mit obligater Pedal. By
Bernhard Fr. Richter.

3. Cembalo oder Pianoforte? By Richard Buchmayer.
4. Bearbeitung Bachscher Kantaten. By Max Schneider. [275]
5. Nachrichten über das Leben Georg Böhms mit
spezieller Berücksichtigung seiner Beziehungen zur
...
Abteilung: Arien für Tenor. Ed. Eusebius Mandyczewski.
...
Viola).
9. Tausendfaches Unglück, Schrecken, Trübsal (Cantata
143: Violin).
...
sätzen mitsingen? By Rudolf Wustmann.
...
8. Zu den Beschlüssen des Dessauer Kirchengesangver
einstages. By Arnold Schering.

9. Notes.


X (5). 1910. Fünftes deutsches Bach-Fest in Duisburg 4 bis 7 Juni
...
Arien für Bass, Ed. Eusebius Mandyczewski.


1. Achzen und erbärmlich Weinen (Cantata 13: Violin or
Flute). [277]
...
Viola).
7. Herr, nun lässest du deinen Diener (Cantata 83: Violin
or Viola).
...
d'amore).
12. Wenn Trost und Hülf' ermangeln muss (Cantata 117:
Violin).
...
nen Literatur über Johann Sebastian Bach. By Max
Schneider.
...
3. Erfüllet, ihr bimmlischen, göttlichen Flammen (Cantata 1: Oboe da caccia).

4. Genügsamkeit ist ein Schatz in diesem Leben (Cantata
144: Oboe d'amore).
...
12. Wie zittern und wanken der Sünder Gedanken (Cantata
105: Oboe).
...
4. Zur Geschichte der Passionsaufführungen in Leipzig.
...
6. Über die Viola da Gamba und ihre Verwendung bei
...
1. Wenn die Fruhlingslüfte streichen (“Weichet nur betrübte Schatten”: Violin).
2. Sich üben im Lieben (“Weichet nur betrübte Schatten”:

[280] Oboe).
3. Des Reichtums Glanz (“Ich bin in mir vergnügt”:
Violin). [547]

4. Meine Seele, sei vergnügt (“Ich bin in mir vergnügt”:
Flauto).
...
7. Ei! wie schmeckt der Coffee süsse (“Schweigt stille,
plaudert nicht”: Flauto).
8. Ruhig und in sich zufrieden (“Ich bin in mir vergnügt”:
2 Oboi).
9. Schafe können sicher weiden (“Was mir behagt”: 2
Flauti).
10. Ruhet hie, matte Töne (“O holder Tag”: Violin and
Oboe d'amore).
11. Jagen ist die Lust der Götter (“Was mir behagt”: 2
Horns).
12. Hört doch! der sanften Flöten Chor (“Schleicht, spielende Wellen”: 3 Flauti).


XIII (2). 1913. Solo-Kantate für Sopran, “Mein Herze schwimmt
im Blut,” ausgefunden und herausgegeben von C. A. Martiensen. Partitur.

XIII (3). 1913. Solo-Kantate für Sopran, “Mein Herze schwimmt im
Blut.” Klavierauszug mit Text von Max Schneider.
XIII (4). 1913. Bach-Jahrbuch. 9 Jahrgang 1912: Im Auftrage der
Neuen Bachgesellschaft herausgegeben von Arnold Schering. Mit 2 Noten-Anhängen.
The volume contains the following articles:
...
3. Die Möllersche Handschrift. Ein unbekanntes Gegenstück zum Andreas-Bach-Buche (mit einem Notenanhange). By Werner Wolffheim.
4. Bachs Bearbeitungen und Umarbeitungen eigener und
fremder Werke. By Karl Grunsky.
5. Über die Kirchenkantaten vorbachischer Thomaskan
...
7. Aufführungen von Joh. Seb. Bachs Kompositionen.
By Th. Biebrich.
...
2. Über Joh. Seb. Bachs Konzerte fur drei Klaviere. By

Hans Boas.

3. Die Kantata Nr. 150, “Nach dir, Herr, verlanget mich.”
By Arnold Sobering.
4. Über die C-dur-Fuge aus dem I. Theil des “Wohltemperierten Klaviers.” By Wanda Landowska.

5. Die Varianten der grossen G-moll-Fuge für Orgel
...
7. Breitkopfsche Textdrucke zu Leipziger Musikaufführungen zu Bachs Zeiten. By Hermann von Hase.
...
XV (1). 1914. Ausgewählte Arien und Duette mit einem obligaten Instrument und Klavier- oder Orgelbegleitung. VIII
Abteilung: Arien für Alt. 2 Heft. Ed. Eusebius Mandyczewski.
...
8. Schäme dich, O Seele, nicht (Cantata 147: Oboe
d'amore). [283]
...
1. Neues über das Bachbildnis der Thomasschule und

andere Bildnisse Johann Sebastian Bachs. By Albrecht
Kurzwelly.
2. Zur Geschichte der Bachbewegung. Bericht über eine
bisher unbekannte frühe Aufführung der Matthaüuspassion. By Karl Anton.
3. Johann Christoph Friedrich Bach. By Georg Schüne
mann.

4. Die Wiederbelebung der Kurrende in Eisenach. By W.
Nicolai.

5. Aufführungen von Joh. Seb. Bachs Kompositionen
in der Zeit vom Oktober 1912 bis Juli 1914. By Th.
Biebrich.

6. Bachaufführungen im ersten Jahre des deutschen
...
(Mit einem Anhang über die Kantata “Schleicht, spielende Wellen”). By Woldemar Voigt.
4. Eine alte, unbekannte Skizze von Sebastian Bachs
Leben. By Arthur Prüfer.
...
XXIV.] [285]
XVII (3). 1917. Bach-Urkunden. Ursprung der musikalischBachischen Familie. Nachrichten über Johann Sebastian
...
2. Zur Frage der Ausführung der Ornamente bei Bach.
Zählzeit oder Notenwert? By Hans Joachim Moser.
3. Friedrich Bachs Briefwechsel mit Gerstenberg und
Breitkopf. By Georg Schunemann.
4. Bachaufführurgen im dritten Jahre des deutschen
Krieges. By Th. Biebrich.
5. Laterarische Beigabe: “Der Thomaskantor.” Ein
Gemüth-erfreuend Spiel von deme Herren Cantori Sebastian Bachen, vorgestellt in zween Auffzügen durch
Bernhard Christoph Breitkopfen seel. Erben: Breitkopf
und Hartel 1917. By Arnold Schering.


XVIII (1). 1917. Konzert in D moll nach der ursprünglichen Fassung
fur Violine wiederhergestellt von Robert Reitz. Partitur.

[See B.G. XVII.]
XVIII (2). 1917. Konzert in D moll nach der ursprünglichen Fassung
für Violine wiederhergestellt von Robert Reitz. Ausgabe
...
Johann Christoph W. Kühnau, _Die blinden Tonküstler._
Berlin. 1810.
...
_Kirch-Kantaten und Choralgesängen._ Berlin. 1846.
Johann Carl Schauer, _Johann Sebastian Bachs Lebensbild:_
_Eine Denkschrift auf seinen 100jähringen Todestag._ Jena.
1850.
...
_Meister: Bach, Händel, Gluck, Haydn, Mozart, Beethoven,_
...
_deutung für Cantoren, Organisten, und Schullehrer._ Bleichroder. 1865.

Alfred Dörffel, _Thematisches Verzeichniss der Instrumen-_
...
C. H. Bitter, _C. P. E. und W. F. Bach und deren Brüder._ 2
...
_tikularschule zu St._ _Michaelis in Lüneburg._ Lüneburg.
...
Jul. Schümann, _Joh. Seb. Bach, der Kantor der Thomas-_
...
Wilhelm His, _Johann Sebastian Bach. Forschungen über_
_dessen Grabstätte, Gebeine und Antlitz._ Leipzig. 1895.
Wilhelm His, _Anatomisches Forschungen über J. S. Bach's_
_Gebeine und Antlitz, nebst Bemerkungen über dessen Bilder._
Leipzig. 1895.
...
[Fr. Thomas, _Einige Ergebnisse über J. S. Bachs Ohrdruffer_
...
[W. Tappert, _Sebastian Bachs Kompositionen für die Laute._
Berlin. 1901.]

K. Söhle, _Sebastian Bach in Arnstadt_ Berlin. 1902. 2nd ed.

1904.

Arthur Prüfer, _Sebastian Bach und die Tonkunst des XIX._
...
Jul. Schumann, _Bach, Händel, Mendelssohn._ _Die_
...
Friedrich Hashagen, _Joh. Sebastian Bach als Sänger und_
_Musiker des Evangeliums._ Wismar. 1909.
Max Trümpelmann, _Joh. Sebastian Bach und seine Bedeu-_
_tung für die Choralkomposition unserer Zeit._ Magdeburg.
1909.
...
André Pirro, _Johann Sebastian Bach. Sein Leben und seine_
...
Johannes Schreyer, _Beiträge zur Bach-Kritik._ Leipzig.
1911.
...
_führung in Stil und Technik von Bachs melodischer Poly-_
_phonie._ Bern. 1917.
...
_Sébastien Bach._ [Translated from the German by Felíx
Grenier.] Paris. 1876.
Ernest David, _La vie et les œuvres de J.-S. Bach, sa famille,_
_ses élèves, ses contemporains._ [An abridged translation of
Spitta.] Paris. 1882.
William Cart, _Un maitre deux fois centenaire: étude sur_
_J.-S. Bach, 1685-1750._ Paris. 1884. New ed. 1898.
André Pirro, _L'Orgue de Jean-Sébastien Bach._ Paris. 1895.

[G. Fink, _Étude biographique sur Jean-Sébastien Bach._
Angoulème. 1899.]
...
Albert Schweitzer, _J. S. Bach, le musicien-poète._ Leipzig.
1905.

André Pirro, _J.-S. Bach._ Paris. 1906. 4th edition. 1913.
André Pirro, _L'Esthétique de Jean-Sébastien Bach._ Paris.
...
André Pirro, _Johann Sebastian Bach, the Organist, and his_
...
44).
Page 5. Gott durch deine Güte, or, Gottes Sohn ist
Kommen (ib. 20).
...
Page 69. O Mensch, bewein' dein' Sünde gross (ib.
48).
...
Page 97. Komm, Gott, Schöpfer, heiliger Geist (P. bk.
246 p. 86).
...
Page 117. Wer nur den lieben Gott lässt walten (ib.
57).
Page 119. Alle Menschen müssen sterben (ib. 2).
Page 121. Ach wie nichtig, ach wie flüchtig (ib. 2).


Novello: Book XVI. The Six “Schübler Chorale Preludes”

And The “Clavierübung,” Part III.
...
lieben Gott (ib. 84).
Page 6. Wer nur den lieben Gott lässt walten (ib.
76).
...
Page 39. Allein Gott in der Höh' sei Ehr' (Pk. b.
245 p. 10).
...
Page 49. Wir glauben all' an einen Gott, Schöpfer
(P. bk. 246 p. 78).
...
Page 18. An Wasserflüssen Babylon (P. bk. 245 p.
34).
Page 22. Schmücke dich, O liebe Seele (P. bk. 246 p.
50).
...
Page 56. Allein Gott in der Höh' sei Ehr' (P. bk. 245 p.
26).
...
Page 82. Komm, Gott, Schöpfer, heiliger Geist (P. bk.
246 p. 2).
Page 85. Wenn wir in höchsten Nöthen sein, or, Vor
...
fürcht'st du, Feind Herodes, sehr (P. bk. 244 p. 9).
...
Page 23. Wie schön leuchtet der Morgenstern (not in
P.).
...
version of “Komm, Gott, Schöpfer, heiliger Geist”).
...
const astronomy: string = `### **The Project Gutenberg eBook of History of Astronomy**
...
**(FORMERLY PROFESSOR OF NATURAL PHILOSOPHY, ANDERSON’S COLLEGE,**
**GLASGOW)**


AUTHOR OF “THE TRANSIT OF VENUS,” RENDU’S “THEORY OF THE GLACIERS OF SAVOY,”
ETC., ETC.
...
problem; Kepler and Newton converted the point of view into a dynamical one. Aristotle’s mental capacity to
...
human mind as a logical machine. For it required the new point of view imagined by Newton’s analysis to
enable people to see that, so far as planetary orbits are concerned, Kepler’s three laws (B, C, D) were
identical with Newton’s law of gravitation (A). No one recognises more than the mathematical astronomer
...
mathematical astronomers. Newton’s comparison of himself to the child on the seashore applies to them all.
...
It has been necessary to curtail many parts of the History in the attempt—perhaps a hopeless one—to lay
...
him who still remains pre-eminently its greatest exponent, Euclid. These students pity also the man of tomorrow, who is not to be allowed to read, in the original Latin of the brilliant Kepler, how he was able—by
observations taken from a moving platform, the earth, of the directions of a moving object, Mars—to deduce
the exact shape of the path of each of these planets, and their actual positions on these paths at any time.
Kepler’s masterpiece is one of the most interesting books that was ever written, combining wit, imagination,
...
experiences. During the infancy of each the succession of events can be watched, but there can be no _à priori_
...
If the ancient Chaldæans gave to the planetary conjunctions an influence over terrestrial events, let us
...
announcing the influence of the moon with as much confidence as it is affirmed in Lord Wolseley’s _Soldier’s_
_Pocket Book_ .
...
So Hipparchus, about 150 B.C., and Ptolemy a little later, were able to use the observations of Chaldæan
...
bricks used by the Chaldæans for recording the eclipses of 1062 B.C. and 762 B.C.; and has thereby been
enabled, in the last few years, to correct the lunar tables of Hansen, and to find a more accurate value for the
secular acceleration of the moon’s longitude and the node of her orbit than any that could be obtained from
modern observations made with instruments of the highest precision.

So again, Mr. Hind [[3]] was enabled to trace back the period during which Halley’s comet has been a member
...
The theoretical views founded on Newton’s great law of universal gravitation led to the conclusion that the
inclination of the earth’s equator to the plane of her orbit (the obliquity of the ecliptic) has been diminishing
...
the discoveries, which may have been great, by other peoples—by the Druids, the Mexicans, and the
...
dimensions, but still purely geometrical. Since Kepler’s day we have had a dynamical astronomy.
...
C HALDÆAN B AKED B RICK OR T ABLET,
...
know of the astronomical learning of the Chinese, Indians, Chaldæans, Assyrians, and Egyptians is but the
remnant of a far more complete astronomy of which no trace can be found.


Delambre, in his _Histoire de l’Astronomie Ancienne_ (1817), ridicules the opinion of Bailly, and considers
...
is a complete sphere, and that stars are shining at mid-day, although eclipsed by the sun’s brightness.
...
To learn the length of the year needed only patient observation—a characteristic of the Chinese; but many
younger nations got into a terrible mess with their calendar from ignorance of the year’s length.
...
_Saros_ . It consists of 235 lunations, and in that time the pole of the moon’s orbit revolves just once round the
...
of the solstices, and of the obliquity of the ecliptic—records become rare, until 776 B.C., when eclipses
...
_Chaldæans_ .—Until the last half century historians were accustomed to look back upon the Greeks, who
...
The Chaldæans, being the most ancient Babylonians, held the same station and dignity in the State as did
...
Pingré and Oppolzer fix the date July 16th, 533 B.C. Thus are the relations of the chronologies of Jews and
...
happens when the earth cuts off the sun’s light from her. He supposed the earth to be flat, and to float upon
water. He determined the ratio of the sun’s diameter to its orbit, and apparently made out the diameter
...
sun, and in a lunar eclipse the moon enters the earth’s shadow—both excellent opinions. But he entertained
...
360 days—twelve months of thirty days. Solon’s year was 354 days. It is obvious that these erroneous years
...
number of the year in Melon’s cycle being the golden number of our prayer-books. Melon’s system divided
...
Callippus (330 B.C.) used a cycle four times as long, 940 lunations, but one day short of Melon’s seventysix years. This was more correct.
...
Lewis’s _Historical Survey of the Astronomy of the Ancients_ ; London, 1862. His list of authorities is very
...
found the sun’s diameter, correctly, to be half a degree. Eratosthenes (276-196 B.C.) measured the inclination
to the equator of the sun’s apparent path in the heavens—i.e., he measured the obliquity of the ecliptic,
...
days, 6 hours to 365 days, 5 hours, 53 minutes—still four minutes too much. He measured the equation of
...
He proceeded in the same way to compute Lunar tables. Making use of Chaldæan eclipses, he was able to
get an accurate value of the moon’s mean motion. [Halley, in 1693, compared this value with his own
measurements, and so discovered the acceleration of the moon’s mean motion. This was conclusively
established, but could not be explained by the Newtonian theory for quite a long time.] He determined the
plane of the moon’s orbit and its inclination to the ecliptic. The motion of this plane round the pole of the
ecliptic once in eighteen years complicated the problem. He located the moon’s excentric as he had done the
sun’s. He also discovered some of the minor irregularities of the moon’s motion, due, as Newton’s theory
proves, to the disturbing action of the sun’s attraction.
...
that point in the heavens where the ecliptic is 90° from the poles of the earth—i.e., the equinox. He found
...
necessary for the progress of accurate astronomical observations. It is due to a steady revolution of the earth’s
...
Great Pyramid may have been built γ Draconis was near to the pole, and must have been used as the polestar. In the north face of the Great Pyramid is the entrance to an inclined passage, and six of the nine
pyramids at Gizeh possess the same feature; all the passages being inclined at an angle between 26° and 27°
to the horizon and in the plane of the meridian. It also appears that 4,000 years ago—i.e., about 2100 B.C.—
an observer at the lower end of the passage would be able to see γ Draconis, the then pole-star, at its lower
...
(2) The Chaldæans gave names to constellations now invisible from Babylon which would have been
...
seemed to early commentators a proof of Homer’s inaccuracy. Likewise Homer, both in the _Odyssey_ [[2]] (v.
...
1000 B.C.; and fixes the date of the poems, thus confirming other evidence, and establishing Homer’s
...
“The Pleiades and Boötes that setteth late, and the Bear, which they likewise call the Wain, which turneth
...
the plane of the planet’s orbit. The only object ever aimed at in those days was to prepare tables for
...
Syrian prince, improved the value of excentricity of the sun’s orbit, observed the motion of the moon’s apse,
and thought he detected a smaller progression of the sun’s apse. His tables were much more accurate than
Ptolemy’s. Abul Wefa, in the tenth century, seems to have discovered the moon’s “variation.” Meanwhile the
...
Alphonsine Tables (1488 A.D.), Purbach translated Ptolemy’s book, and observations were carried out in
...
position—a test which failed completely with the rough means of observation then available. The radical
defect of all solar systems previous to the time of Kepler (1609 A.D.) was the slavish yielding to Plato’s
...
with observation. And this he proceeded to do. [[6]] Moreover, observers had found irregularities in the moon’s
...
Copernicus made this rotation of the earth’s axis about the pole of the ecliptic retrograde (i.e., opposite to
...
theory: he merely sought to make it more simple by placing the centre of the earth’s
...
itself centred on a deferent, excentric to the earth. The earth’s axis rotates about the pole of the ecliptic,
...
—those who have evidently read his great book—are very cautious in the words with which they eulogise
...
astronomers acquainted with Kepler’s work, but by those who desired to put the Church in the wrong by
...
than it deserves. On reading Airy’s account of epicycles, in the beautifully clear language of his _Six Lectures_
...
watching the clock, and recording. (From the author’s

copy of the _Astronomiæ Instauratæ Mechanica_ .)
...
For a complete life of this great man the reader is referred to Dreyer’s _Tycho Brahe_, Edinburgh, 1890,
...
out his life’s work in that country. He granted to him the island of Hveen, gave him a pension, and made him
...
Alexandria, and other armillae designed by himself—sextants, mural quadrants, large celestial globes and
...
the positions of Tycho’s standard stars are compared with the best modern catalogues, his probable error in
...
“variation” by observing the moon in all phases—a thing which had not been attended to. [It is remarkable
...
wanted to add another epicycle to the moon’s orbit, but he feared that these would soon become
...
Copernicus, that Luther (Luther’s _Tischreden_, pp. 22, 60) derided him in his usual pithy manner, that
Melancthon ( _Initia doctrinae physicae_ ) said that Scripture, and also science, are against the earth’s motion;
...
It has seemed to many that Plato’s demand for uniform circular motion (linear or angular) was responsible
for a loss to astronomy of good work during fifteen hundred years, for a hundred ill-considered speculative
cosmogonies, for dissatisfaction, amounting to disgust, with these _à priori_ guesses, and for the relegation of
...
from the deferent, and so on). He says that, after using all these devices to make theory agree with Tycho’s
...
Kepler. No one who reads Kepler’s great book could hold such an opinion for a moment. In fact, the
excellence of Copernicus’s book helped to prolong the life of the epicyclical theories in opposition to
Kepler’s teaching.
...
being actually outside the planes in which they move. Kepler’s first great discovery was that the planes of all
...
utterly feeble that the meaning of the words in Kepler’s three laws could not be understood until expounded
...
on _Harmonics_, which is not now quoted, only lest someone might say it was egotistical—a term which is
simply grotesque when applied to such a man with such a life’s work accomplished.
...
the earth’s orbit. Observe the date at any time when Mars is in opposition. The earth’s position E at that date
...
magnetism, and speaks of the work of Gilbert of Colchester. (Gilbert’s book, _De Mundo Nostro Sublunari,_
_Philosophia Nova_, Amstelodami, 1651, containing similar views, was published forty-eight years after
Gilbert’s death, and forty-two years after Kepler’s book and reference. His book _De Magnete_ was published
in 1600.)


A few of Kepler’s views on gravitation, extracted from the Introduction to his _Astronomia Nova_, may now
be mentioned:—
...
3. Bodies are attracted to the earth’s centre, not because it is the centre of the universe, but because it is the
...
From the all too brief epitome here given of Kepler’s greatest book, it must be obvious that he had at that
time some inkling of the meaning of his laws—universal gravitation. From that moment the idea of universal
...
[1] When the writer visited M. D’Arrest, the astronomer, at Copenhagen, in 1872, he was presented by
D’Arrest with one of several bricks collected from the ruins of Uraniborg. This was one of his most cherished
...
[3] The ruled logarithmic paper we now use was not then to be had by going into a stationer’s shop. Else he
...
account of work in a different direction originated by a contemporary of Kepler’s, his senior in fact by seven
...
The laws of motion had not been correctly defined. The only man of Galileo’s time who seems to have
...
But it was work of a different kind that established Galileo’s popular reputation. In 1609 Galileo heard that
...
His fame flew over Europe like magic, and his discoveries were much discussed—and there were many
...
He thought that these discoveries proved the truth of the Copernican theory of the Earth’s motion; and he
...
cardinals as well as by the dignitaries of the Reformed Church. Galileo—a good Catholic—got mixed up in
...
Galileo onwards, for some time, opponents of religion included the theory of the Earth’s motion in their
...
Galileo died on Christmas Day, 1642—the day of Newton’s birth. The further consideration of the grand
...
He discovered the errors in Jupiter’s calculated place, due to what we now know as the long inequality of
Jupiter and Saturn, and measured with considerable accuracy the acceleration at that date of Jupiter’s mean
motion, and indicated the retardation of Saturn’s mean motion.
...
that the sun’s force must clearly be unequal at different distances, for the pull out of the tangential line in a
...
Newton’s _Principia (Philosophiae Naturalis Principia Mathematica)_ . In this great work Newton started from
the beginning of things, the laws of motion, and carried his argument, step by step, into every branch of
physical astronomy; giving the physical meaning of Kepler’s three laws, and explaining, or indicating the
...
Having developed and enunciated the true laws of motion, he was able to show that Kepler’s second law
(that equal areas are described by the line from the planet to the sun in equal times) was only another way of
saying that the centripetal force on a planet is always directed to the sun. Also that Kepler’s first law (elliptic
orbits with the sun in one focus) was only another way of saying that the force urging a planet to the sun
varies inversely as the square of the distance. Also (if these two be granted) it follows that Kepler’s third law
is only another way of saying that the sun’s force on different planets (besides depending as above on
...
the meaning of Kepler’s laws in propositions which have been summarised as follows:—
...
in a second. The moon is 60 times farther from the earth’s centre than the stone, so it ought to be drawn out
of a straight course through 16.1 feet in a minute. Newton found the distance through which she is actually
drawn as a fraction of the earth’s diameter. But when he first examined this matter he proceeded to use a
...
an accurate value of the earth’s diameter. Newton applied this value, and found, to his great joy, that when the
...
The universality claimed for the law—if not by Newton, at least by his commentators—was bold, and
...
due to the earth’s rotation, and that these should cause a flattening of the poles. He invented a mathematical
...
the effect ought to be a rotation of the earth’s axis over a conical surface in space, exactly as the axis of a top
...
any one of the sections of a cone—a circle, ellipse, parabola, or hyperbola; and he found that those comets of
...
they revolve, the new law must involve irregularities, due to their mutual action—such, in fact, as Horrocks
had indicated. He determined to put this to a test in the case of the moon, and to calculate the sun’s effect,
...
Newton’s calculation was not exact.
...
Newton’s method of calculating the precession of the equinoxes, already referred to, is as beautiful as
anything in the _Principia_ . He had already proved the regression of the nodes of a satellite moving in an orbit
inclined to the ecliptic. He now said that the nodes of a ring of satellites revolving round the earth’s equator
would consequently all regress. And if joined into a solid ring its node would regress; and it would do so,


only more slowly, if encumbered by the spherical part of the earth’s mass. Therefore the axis of the equatorial
...
contribute directly to the mathematical proofs of Newton’s theory, yet his name is closely associated with
some of its greatest successes.

He was the first to detect the acceleration of the moon’s mean motion. Hipparchus, having compared his
own observations with those of more ancient astronomers, supplied an accurate value of the moon’s mean
...
A.D., and two later ones up to the tenth century. He found that to explain these eclipses Halley’s suggestion
...
established by indisputable evidence that the secular inequality of the moon’s mean motion cannot be
...
purpose. But in 1787 he gave the true explanation. The principal effect of the sun on the moon’s orbit is to
diminish the earth’s influence, thus lengthening the period to a new value generally taken as constant. But
Laplace’s calculations showed the new value to depend upon the excentricity of the earth’s orbit, which,
according; to theory, has a periodical variation of enormous period, and has been continually diminishing for
thousands of years. Thus the solar influence has been diminishing, and the moon’s mean motion increased.
Laplace computed the amount at 10” in one century, agreeing with observation. (Later on Adams showed that
Laplace’s calculation was wrong, and that the value he found was too large; so, part of the acceleration is
now attributed by some astronomers to a lengthening of the day by tidal friction.)

Another contribution by Halley to the verification of Newton’s law was made when he went to St. Helena
to catalogue the southern stars. He measured the change in length of the second’s pendulum in different
...
Laplace justly said: “These inequalities appeared formerly to be inexplicable by the law of gravitation—they
...
in elongated ellipses, practically undistinguishable, in the visible part of their paths, from parabolæ, in which
...
Once again Halley’s suggestion became an inspiration for the mathematical astronomer. Clairaut, assisted
...
When Halley’s comet reappeared in 1835, Pontecoulant’s computations for the date of perihelion passage
...
these have been identified as being really Halley’s comet by the calculations of Cowell and Cromellin [[4]] (of
...
which for two hundred years have been establishing the universality of Newton’s law. The lunar and
planetary theories, the beautiful theory of Jupiter’s satellites, the figure of the earth, and the tides, were
mathematically treated by Maclaurin, D’Alembert, Legendre, Clairaut, Euler, Lagrange, Laplace, Walmsley,
...
than four times the earth’s distance. Lexell was the first to suspect that this was a new planet eighteen times
...
In 1772, before Herschel’s discovery, Bode [[1]] had discovered a curious arbitrary law of planetary distances.
Opposite each planet’s name write the figure 4; and, in succession, add the numbers 0, 3, 6, 12, 24, 48, 96,
...
disappeared in the sun’s rays. Gauss published an approximate ephemeris of probable positions when the


planet should emerge from the sun’s light. There was an exciting hunt, and on December 31st (the day before
its birthday) De Zach captured the truant, and Piazzi christened it Ceres.


The mean distance from the sun was found to be 2.767, agreeing with the 2.8 given by Bode’s law. Its orbit
...
powers of Newton’s great law to explain any planetary irregularity.
...
observations of Uranus’s position, from the time of Flamsteed, in 1690, had been recorded.
...
research which as an undergraduate he had set himself—to see whether the disturbances of Uranus could be
...
declaring his belief in Adams’s capabilities. When Adams called on him Airy was away from home, but at the
...
had done, that Airy’s very natural inquiry showed no proportionate desire to search for the planet. Anyway,
...
In June, 1846, Le Verrier announced, in the _Comptes Rendus de l’Academie des Sciences_, that the
longitude of the disturbing planet, for January 1st, 1847, was 325, and that the probable error did not exceed
10°.


This result agreed so well with Adams’s (within 1°) that Airy urged Challis to apply the splendid
...
catalogue, or chart, of all stars near Adams’s position.
...
very part of the heavens including Le Verrier’s position; thus eliminating all of Challis’s preliminary work.
The letter was received in Berlin on September 23rd; and the same evening Galle found the new planet, of
the eighth magnitude, the size of its disc agreeing with Le Verrier’s prediction, and the heliocentric longitude
...
and every success that enables the mind’s eye to see a little more clearly the meaning of things has always
...
inequalities in Uranus’s motion to mean that an unknown planet was in a certain place in the heavens, where
it was found.


At the time there was an unpleasant display of international jealousy. The British people thought that the
earlier date of Adams’s work, and of the observation by Challis, entitled him to at least an equal share of
...
[1] Bode’s law, or something like it, had already been fore-shadowed by Kepler and others, especially Titius
...
described as “radiant matter.” Nor is it quite certain that Laplace’s proofs of the instantaneous propagation of
gravity are final.

And in the future, as in the past, Tycho Brahe’s dictum must be maintained, that all theory shall be
...
Tycho’s largest quadrant had a diameter of nine feet, and the quadrant a radius of six feet. He introduced the
...
with his “armillae æquatoriæ maximæ,” with which he observed the comet of 1585, besides fixed stars and
planets. [[3]]


The discovery by Galileo of the isochronism of the pendulum, followed by Huyghens’s adaptation of that
...
sights and clocks were required for proving some of Newton’s theories of planetary perturbations. Picard’s
observations at Paris from 1667 onwards seem to embody the first use of the telescope as a pointer. He was
also the first to introduce the use of Huyghens’s clocks for observing the right ascension of stars. Olaus
Romer was born at Copenhagen in 1644. In 1675, by careful study of the times of eclipses of Jupiter’s
...
Halley succeeded Flamsteed to find that the whole place had been gutted by the latter’s executors. In 1721
he got a transit instrument, and in 1726 a mural quadrant by Graham. His successor in 1742, Bradley,
replaced this by a fine brass quadrant, eight feet radius, by Bird; and Bradley’s zenith sector was purchased
...
Bradley had set up this instrument at Kew, to attempt the proof of the earth’s motion by observing the annual
...
reduced by Bessel and published in 1818, at Königsberg, in his well-known standard work, _Fundamenta_
...
Bird’s quadrant by a fine new mural _circle_, six feet in diameter, by Troughton, the divisions being read off by
...
lunar observations more continuous, Airy employed Troughton’s successor, James Simms, in conjunction
...
threefold, many of them being in a part of the moon’s orbit which had previously been bare of observations.
...
the irregularities could be allowed for, being due to that remarkable variation in the position of the earth’s
...
perhaps, in fixing the positions of faint satellites. Thus Saturn’s distant satellite, Phoebe, and the sixth and
...
satellite, which enabled Mr. Melotte to find it again in the autumn—a great triumph both of calculation and of
...
made great use of it. But in the hands of Sir David Gill (late His Majesty’s Astronomer at the Cape of Good
...
has been specially brought into prominence by Sir David Gill’s researches on the distance of the sun— _i.e.,_
...
In 1877 Sir David Gill used Lord Crawford’s heliometer at the Island of Ascension to measure the parallax
of Mars in opposition, and found the sun’s distance 93,080,000 miles. He considered that, while the
...
earth’s mass = 0.012240.


Another method of getting the distance from the sun is to measure the velocity of the earth’s orbital
...
earth’s velocity to the velocity of light. The velocity of light is 186,000 miles a second; whence the distance
...
from a star by observations taken six months apart. Thence he obtained an accurate value of the sun’s
distance. [[5]]
...
[3] See Dreyer’s article on these instruments in _Copernicus_, Vol. I. They were stolen by the Germans after the
...
Astronomer Royal at a time, as there is only one Mikado, one Dalai Lama. He said that His Majesty’s
Astronomer at the Cape of Good Hope, His Majesty’s Astronomer for Scotland, and His Majesty’s
...
Newton’s trouble with refractors, chromatic aberration, remained insurmountable until John Dollond (born
1706, died 1761), after many experiments, found out how to make an achromatic lens out of two lenses—one
of crown glass, the other of flint glass—to destroy the colour, in a way originally suggested by Euler. He soon
...
him up in 1805, and soon produced, among others, Struve’s Dorpat refractor of 9.9 inches diameter and 13.5
feet focal length, and another, of 12 inches diameter and 18 feet focal length, for Lamont, of Munich.

In the nineteenth century gigantic _reflectors_ have been made. Lassel’s 2-foot reflector, made by himself,
did much good work, and discovered four new satellites. But Lord Rosse’s 6-foot reflector, 54 feet focal
...
have been made of silvered glass, and Dr. Common’s 5-foot speculum (removed, since his death, to Harvard)
...
Nice 29½-inch by Gautier, the Pulkowa 30-inch by Clark. Then there was the sensation of Clark’s 36-inch for
...
Mr. Frank McClean’s 24-inch refractor, with an object-glass prism for spectroscopic work.


It would be out of place to describe here the practical adjuncts of a modern equatoreal—the adjustments
...
Frauenhofer, at the beginning of the nineteenth century, while applying Dollond’s discovery to make large
...
deflected to different extents—the violet most, the red least. The number of colours forming images is so
numerous as to form a continuous spectrum on the wall with all the colours—red, orange, yellow, green,
...
attributed them to absorption in the earth’s atmosphere. He suggested that the others were due to absorption
in the sun’s atmosphere. Thereupon Professor J. D. Forbes pointed out that during a nearly total eclipse the
lines ought to be strengthened in the same way; as that part of the sun’s light, coming from its edge, passes
through a great distance in the sun’s atmosphere. He tried this with the annular eclipse of 1836, with a
negative result which has never been accounted for, and which seemed to condemn Brewster’s view.

In 1859 Kirchoff, on repeating Frauenhofer’s experiment, found that, if a spirit lamp with salt in the flame
...
sun’s atmosphere. [[4]] Iron, calcium, and other elements were soon detected in the same way.
...
In 1873 Vogel [[7]] compared the spectra of the sun’s East (approaching) limb and West (receding) limb, and
the displacement of lines endorsed the theory. This last observation was suggested by Zöllner.


**FOOTNOTES:**


[1] In the _Encyclopaedia Britannica_, article “Telescope,” and in Grant’s _Physical Astronomy_, good reasons
...
their mathematics defective through want of use? James Gregory’s nephew David had a heap of MS. notes by
...
(the discoverer of Neptune), for his opinion. Adams’s final verdict was: “I fear they are of no value. It is
pretty evident that, when he wrote these notes, _Newton’s mathematics were a little rusty_ .”
...
[5] _Abh. d. Kön. Böhm. d. Wiss_ ., Bd. ii., 1841-42, p. 467. See also Fizeau in the _Ann. de Chem. et de Phys_ .,
1870, p. 211.
...
Throughout this evolution of thought and conjecture there were two types of astronomers—those who
...
the dictum of Tycho Brahe—not to make theories until all the necessary facts are obtained. The great
astronomers of to-day still hold to Sir Isaac Newton’s declaration, “Hypotheses non fingo.” Each one may
...
One of Galileo’s most striking discoveries, when he pointed his telescope to the heavenly bodies, was that
...
limb. The faculae, or bright areas, which are seen all over the sun’s surface, but specially in the
neighbourhood of spots, and most distinctly near the sun’s edge, were discovered by Galileo. A high
telescopic power resolves their structure into an appearance like willow-leaves, or rice-grains, fairly uniform
in size, and more marked than on other parts of the sun’s surface.


S OLAR S URFACE .
As Photographed at the Royal Observatory, Greenwich, showing

sun-spots with umbræ, penumbræ, and faculæ.


Speculations as to the cause of sun-spots have never ceased from Galileo’s time to ours. He supposed them
...
of the spot over the sun’s surface; exactly as if the spot were a hollow, with a black base and grey shelving
...
is nearest the truth. The obstacle—one that is perhaps fatal to a real theory—lies in the impossibility of
reproducing comparative experiments in our laboratories or in our atmosphere.


Sir William Herschel propounded an explanation of Wilson’s observation which received much notice, but
...
affecting all of the three magnetic elements—declination, dip, and intensity. Australian and Canadian
...
Solar photography has deprived astronomers of the type of Carrington of the delight in devoting a life’s
...
and have given us an accurate record of the sun’s surface. Gelatine dry plates were first used by Huggins in
1876.
...
one case the faculæ were discovered to be sailing over a spot apparently at some considerable height. These
appearances may be partly due to a proper motion; but, so far as it went, this was a beautiful confirmation of
Wilson’s discovery. Hewlett, however, in 1894, after thirty years of work, showed that the spots are not
...
the faculæ generally follow the spots in their rotation round the sun.


The constitution of the sun’s photosphere, the layer which is the principal light-source on the sun, has
...
have succeeded in photographing the sun’s surface in monochromatic light, such as the light given off as one
...
same direction behind the second slit; and as successive sections of the sun’s image in the equatoreal enter
the apparatus, so are these sections successively thrown in their proper place on the photographic plate,
always in K light. By using a high dispersion the faculæ which give off K light can be correctly
photographed, not only at the sun’s edge, but all over his surface. The actual mechanical method of carrying
out the observation is not quite so simple as what is here described.

By choosing another line of the spectrum instead of calcium K—for example, the hydrogen line H (3) —we
...
as the earth. Ångstrom was the first to map out all of the lines to be found in the solar spectrum. But
...
seen round the moon’s edge, and the corona with its streamers radiating or interlacing, have much detail that
...
sun’s surface? How is it that it opposed no resistance to the motion of comets which have almost grazed the
sun’s surface? Is this the origin of the zodiacal light? The character of the corona in photographic records has
been shown to depend upon the phase of the sun-spot period. During the sun-spot maximum the corona
seems most developed over the spot-zones—i.e., neither at the equator nor the poles. The four great sheaves
...
So bright was it that Jansen exclaimed: “ _Je verrai ces lignes-là en dehors des éclipses_ .” And the next day he
...
dispersion. On October 20th Lockyer, [[10]] having news of the eclipse, but not of Jansen’s observations the day
...
The spectrum of the corona is partly continuous, indicating light reflected from the sun’s body. But it also
...
_corona_ surrounds all of these, and extends to vast distances outside the sun’s visible surface.
...
[5] _Periodicität der Sonnenflecken. Astron. Nach. XXI._, 1844, P. 234.
...
_The Moon_ .—Telescopic discoveries about the moon commence with Galileo’s discovery that her surface
...
Shröter supported this opinion. W. Herschel opposed it. But Beer and Mädler measured the heights of lunar
...
charts of Schröter, Beer and Mädler (1837), and of Schmidt, of Athens (1878); and, above all, the
photographic atlas by Loewy and Puiseux.


The details of the moon’s surface require for their discussion a whole book, like that of Neison or the one
...
the small crater _Linné_, in the _Mare Serenitatis_ . It is now generally agreed that no certainty can be expected
...
crater (Mösting A), instead of the moon’s edge, as the point whose distance is to be measured.
...
twenty-three hours, by observing a bright spot on her surface. Shröter made it 23h. 21m. 19s. This value was
...
sun’s surface or during an eclipse. It has even been named _Vulcan_ . These announcements would have
...
proceeding in the two white caps which are seen at the planet’s poles. W. Herschel attributed these caps to ice
and snow, and the dates of his observations indicated a melting of these ice-caps in the Martian summer.


Schroter attributed the other markings on Mars to drifting clouds. But Beer and Mädler, in 1830-39,
...
Arago in 1813, and nearly all the markings recorded by Beer and Mädler in 1830, were seen and drawn by F.
Kaiser in Leyden during seventeen nights of the opposition of 1862 ( _Ast. Nacht._, No. 1,468), whence he
deduced the period of rotation to be 24h. 37m. 22s.,62—or one-tenth of a second less than the period deduced
...
refractor, and Asaph Hall searched for satellites, concealing the planet’s disc to avoid the glare. On August
...
satellite’s shadow, the belts, and the “great red spot” ( _Monthly_

_Notices_, R. A. S., vol. lix., pl. x.).


_Jupiter._ —Galileo’s discovery of Jupiter’s satellites was followed by the discovery of his belts. Zucchi and
...
Jupiter’s rapid rotation ought, according to Newton’s theory, to be accompanied by a great flattening at the
poles. Cassini had noted an oval form in 1691. This was confirmed by La Hire, Römer, and Picard. Pound
measured the ellipticity = 1/(13.25).


W. Herschel supposed the spots to be masses of cloud in the atmosphere—an opinion still accepted. Many
of them were very permanent. Cassini’s great spot vanished and reappeared nine times between 1665 and
...
presenting to us a portion of its surface, which does not well reflect the sun’s light; proving that it always
turns the same face to Jupiter, as is the case with our moon. This fact had also been established for Saturn’s
...
In modern times much interest has been taken in watching a rival to Cassini’s famous spot. The “great red
...
minutes than the red spot—a difference of 260 miles an hour. Thus they came together again every six weeks,
...
Galileo’s great discovery of Jupiter’s four moons was the last word in this connection until September 9th,
...
next one (seventh), in these two points agreeing with the outermost of Saturn’s satellites (Phoebe).

_Saturn._ —This planet, with its marvellous ring, was perhaps the most wonderful object of those first
examined by Galileo’s telescope. He was followed by Dominique Cassini, who detected bands like Jupiter’s
...
ever since, a unique structure. We in this age have got accustomed to it. But Huyghens’s discovery was
received with amazement.


In 1675 Cassini found the ring to be double, the concentric rings being separated by a black band—a fact
...
that it was thrown off from Saturn’s equator as a liquid ring, and afterwards solidified. He noticed that the
...
has been proved by the spectroscope in Keeler’s hands, 1895.
...
The occasional disappearance of Cassini’s Japetus was found on investigation to be due to the same causes
as that of Jupiter’s fourth satellite, and proves that it always turns the same face to the planet.
...
satellites to Uranus in 1851, and found Neptune’s satellite in 1846. All of the satellites of Uranus have
...
perturbations and ephemerides by Euler’s and Lagrange’s method of variable elements became so laborious
...
finding the sun’s distance.

A group of four asteroids has lately been found, with a mean distance and period equal to that of Jupiter.
To three of these masculine names have been given—Hector, Patroclus, Achilles; the other has not yet been
named.
...
desire for a search, all the observations of Fabricius and of Heller, and also a map of the comet’s path among
...
the spectrum of a comet, and saw three bright bands, thus proving that it was a gas and at least partly selfluminous. In 1868 Huggins compared the spectrum of Winnecke’s comet with that of a Geissler tube
...
Halley’s comet remained the only one of which a prediction of the return had been confirmed, until the
...
the same as Jupiter’s mean distance; and six have an aphelion distance about ten per cent, greater than
Neptune’s mean distance. Other comets are similarly associated with the planets Saturn and Uranus.
...
Encke’s comet, the splitting of Biela’s comet into two comets in 1846, and the somewhat similar behaviour of
other comets. It must be noted, however, that comets have a sensible size, that all their parts cannot travel in
exactly the same orbit under the sun’s gravitation, and that their mass is not sufficient to retain the parts
together very forcibly; also that the inevitable collision of particles, or else fluid friction, is absorbing energy,
and so reducing the comet’s velocity.
...
comet, if it does not separate into discrete parts like Biela’s, must in time have its parts spread out so as to
cover a sensible part of the orbit, and that, when the earth passes through such part of a comet’s orbit, a
...
orbital velocity of the meteors in perihelion; and, by comparing this with the earth’s velocity, the latitude of
...
meteor shower (Perseids), and to show its identity with the orbit of Tuttle’s comet 1862.iii. Then, in January
1867, Le Verrier gave the elements of the November meteor shower (Leonids); and Peters, of Altona,
identified these with Oppolzer’s elements for Tempel’s comet 1866—Schiaparelli having independently
...
Halley’s comet since November, 1907, although its perihelion passage will not take place until April, 1910.


**FOOTNOTES:**


[1] In 1874, when the writer was crossing the Pacific Ocean in H.M.S. “Scout,” Coggia’s comet unexpectedly
...
_Theatrum Cometicum_, by S. de Lubienietz, 1667; _Cometographie_, by Pingré, Paris, 1783; _Donati’s Comet_, by
Bond.
...
astronomy among the stars—viz., that the law of gravitation extends to the most distant stars, and that many
...
He discovered 2,500 nebulæ and 806 double stars, counted the stars in 3,400 guage-fields, and compared the
...
in ellipses round each other; just as Bradley’s attack on stellar parallax failed, but led to the discovery of
aberration, nutation, and the true velocity of light.


_Parallax_ .—The absence of stellar parallax was the great objection to any theory of the earth’s motion prior
to Kepler’s time. It is true that Kepler’s theory itself could have been geometrically expressed equally well
with the earth or any other point fixed. But in Kepler’s case the obviously implied physical theory of the
planetary motions, even before Newton explained the simplicity of conception involved, made astronomers
quite ready to waive the claim for a rigid proof of the earth’s motion by measurement of an annual parallax of
stars, which they had insisted on in respect of Copernicus’s revival of the idea of the earth’s orbital motion.
...
Cape of Good Hope, observed α Centauri, whose annual proper motion he found to amount to 3".6, in 18323; and a few years later deduced its parallax 1".16. His successor at the Cape, Maclear, reduced this to 0".92.


In 1835 Struve assigned a doubtful parallax of 0".261 to Vega (α Lyræ). But Bessel’s observations,
...
Later determinations for α 2 Centauri, by Gill, [[2]] make its parallax 0".75—This is the nearest known fixed
star; and its light takes 4 1/3 years to reach us. The lightyear is taken as the unit of measurement in the starry
heavens, as the earth’s mean distance is “the astronomical unit” for the solar system. [[3]] The proper motions
and parallaxes combined tell us the velocity of the motion of these stars across the line of sight: α Centauri
...
amounting to a twentieth of a second of arc. Among these are Canopus, α Orionis, α Cygni, β Centauri, and γ
...
of the motion that is in the line of sight. For a complete knowledge of a star’s motion the proper motion and
...
of star spectra diminished the accuracy; but Vögel, in 1888, overcame this to a great extent by long exposures
...
sight. Thus in the Great Bear, β, γ, δ, ε, ζ, all agree as to angular proper motion. δ was too faint for a
...
sight which, so far as the sun’s motion is concerned, would give a maximum rate of approach for stars near
Hercules, a maximum rate of recession for stars in the opposite part of the heavens, and no effect for stars
half-way between. In this way the spectroscope has confirmed generally Herschel’s view of the direction, and
...
firm of Carl Zeiss, has vastly extended the applications of stereoscopic vision to astronomy—a subject which
...
He photographs stars in a direction at right angles to the line of the sun’s motion. He has taken photographs
...
annual parallax of the stars. In this he was following a suggestion of Galileo’s. The presumption is that, if
...
of some of these: Castor, 342 years; δ Serpentis, 375 years; γ Leonis, 1,200 years; ε Bootis, 1,681 years.

Twenty years later Sir John Herschel and Sir James South, after re-examination of these stars, confirmed [[12]]
and extended the results, one pair of Coronæ having in the interval completed more than a whole revolution.
...
of their law of force with Newton’s force of gravitation applied to the solar system, and the force that makes
...
shortest period he found was eleven years (κ Pegasi). In the case of some of these binaries the parallax has
...
imagination became possible, and was realised by Bessel—the discovery of an unknown body by its
...
twenty suns; but the companion, having a mass equal to our sun, has only a five-hundredth part of the sun’s
brightness.
...
1889, discovered this in the case of Spica (α Virginis), whose period is 4d. 0h. 19m., and the diameter of
whose orbit is six million miles. Great numbers of binaries of this type have since then been discovered, all
of short period.

Also, in 1889, Pickering found that at regular intervals of fifty-two days the lines in the spectrum of ζ of
...
is interposed between us. This should give rise either to intermittence in the star’s light or else to variability.
It was by supposing the existence of a dark companion to Algol that its discoverer, Goodricke of York, [[16]] in
1783, explained variable stars of this type. Algol (β Persei) completes the period of variable brightness in
...
each eclipse; thus entirely supporting Goodricke’s opinion. There are many variables of the Algol type, and
...
“Novæ” was discovered in Auriga by a Scotsman, Dr. Anderson, on February 1st, 1892, and, with the
modesty of his race, he communicated the fact to His Majesty’s Astronomer for Scotland on an unsigned
...
condensations. In February, 1902, it could still be seen with an opera-glass. As with the other Novæ, when it
...
produced by individuals or by observatories. Bradley’s monumental work may be said to head the list.
Lacaille’s, in the Southern hemisphere, was complementary. Then Piazzi, Lalande, Groombridge, and Bessel
were followed by Argelander with his 324,000 stars, Rumker’s Paramatta catalogue of the southern
hemisphere, and the frequent catalogues of national observatories. Later the Astronomische Gesellschaft
started their great catalogue, the combined work of many observatories. Other southern ones were Gould’s at
Cordova and Stone’s at the Cape.
...
observatory equatoreal, driven by clockwork, and adjusted on the comet by the eye. The result with half-anhour’s exposure was good, so he tried three hours. The result was such a display of sharp star images that he
resolved on the Cape Photographic Durchmusterung, which after fourteen years, with Kapteyn’s aid in
reducing, was completed. Meanwhile the brothers Henry, of Paris, were engaged in going over Chacornac’s
zodiacal stars, and were about to catalogue the Milky Way portion, a serious labour, when they saw Gill’s
...
_Nebulæ and Star-clusters._ —Our knowledge of nebulæ really dates from the time of W. Herschel. In his
great sweeps of the heavens with his giant telescopes he opened in this direction a new branch of astronomy.
At one time he held that all nebulæ might be clusters of innumerable minute stars at a great distance. Then he
recognised the different classes of nebulæ, and became convinced that there is a widely-diffused “shining
fluid” in space, though many so-called nebulæ could be resolved by large telescopes into stars. He considered
that the Milky Way is a great star cluster, whose form may be conjectured from numerous star-gaugings. He
supposed that the compact “planetary nebulæ” might show a stage of evolution from the diffuse nebulæ, and
...
When Sir John Herschel had extended his father’s researches into the Southern Hemisphere he was also
...
subsequent extension of this observation to other nebulæ; thus providing a certain test which increase in the
...
Other nebulæ, and especially the white ones like that in Andromeda, which have not yet been resolved into
...
The association of stars with planetary nebulæ, and the distribution of nebulæ in the heavens, especially in
...
The third class includes α Herculis, α Orionis (Betelgeux), Mira Ceti, and about 500 red and variable stars.
...
spectrum belongs to each stage of a star’s life, and how to distinguish between one that is increasing and
...
in the spectra of metalloids and compounds; and other equally pertinent matters—until that time arrives the
...
Laplace as a note in his _Système du Monde_, supposes the solar system to have been a flat, disk-shaped nebula
...
wish to maintain the position of astronomy as the most exact of the sciences—exact in its facts, exact in its
logic—this speculation must be recorded by the historian, only as he records the guesses of the ancient
...
original papers to various journals, references to which may be found in the footnotes of Miss Clerke’s
_History of Astronomy during the Nineteenth Century_ . The same can be said of Bredichin’s hypothesis of
comets’ tails, Arrhenius’s book on the applications of the theory of light repulsion, the speculations on
radium, the origin of the sun’s heat and the age of the earth, the electron hypothesis of terrestrial magnetism,
...
[2] One of the most valuable contributions to our knowledge of stellar parallaxes is the result of Gill’s work
( _Cape Results_, vol. iii., part ii., 1900).


[3] Taking the velocity of light at 186,000 miles a second, and the earth’s mean distance at 93,000,000 miles,
1 light-year=5,865,696,000,000 miles or 63,072 astronomical units; 1 astronomical unit a year=2.94 miles a
second; and the earth’s orbital velocity=18.5 miles a second.
...
[9] See Kapteyn’s address to the Royal Institution, 1908. Also Gill’s presidential address to the British
Association, 1907.
...
watching the clock, and recording. (From the author’s copy of the _Astronomiæ Instauratæ Mechanica_ .)
...
S OLAR S URFACE .
As Photographed at the Royal Observatory, Greenwich, showing sun spots with umbræ, penumbræ, and
faculæ.
...
J UPITER .
From a drawing by E. M. Antoniadi, showing transit of a satellite’s shadow, the belts, and the “great red
